...
const CONTRIBUTIONS: Contribution[] = [
  {
    ...
    contributionDescription:
      'Fixed a bug in the route handling system that caused specific edge cases to fail with URL parameters.',
    date: '2023-10-15',
  },
  {
    repo: 'vercel/next.js',
    ...
    contributionDescription:
      'Improved documentation for API routes with detailed examples and edge cases for handling different request methods.',
    date: '2023-09-22',
  },
  {
    repo: 'prisma/prisma',
    ...
    contributionDescription:
      'Reported and helped debug an issue with relation queries that affected performance in specific scenarios.',
    date: '2023-08-05',
  },
  {
    ...
    contributionDescription:
      'Added support for a new animation variant that allows more control over animation timing and behavior.',
    date: '2023-07-18',
  },
];
  ...
  return (
    <div className="space-y-8">
      <p className="text-center text-muted-foreground max-w-2xl mx-auto mb-8">
        I actively contribute to open source projects, focusing on improving documentation, fixing
        bugs, and adding features to projects I use daily.
      </p>
              ...
              <CardFooter>
                <div className="flex items-center gap-6 text-xs text-muted-foreground">
                  <Button asChild variant="link" className="h-auto p-0 text-primary">
                    <Link href={contribution.repoUrl} target="_blank" rel="noopener noreferrer">
      ...
      <div className="text-center pt-6">
        <p className="text-sm text-muted-foreground mb-4">
          These are just a few examples of my open source contributions. Check out my GitHub profile
          for more.
        </p>
