...
const BLOG_POSTS: BlogPost[] = [
  ...
  },
  {
    ...
    excerpt: "Discover techniques for keeping your TailwindCSS codebase clean, organized, and maintainable as your project grows.",
    date: "2023-10-18",
  ...
  },
  {
    ...
    excerpt: "Learn how to leverage TypeScript to create fully type-safe React applications, from props and state to API responses and form handling.",
    date: "2023-09-30",
  ...
  },
  {
    ...
    excerpt: "Practical tips and strategies for optimizing database queries in web applications to improve response times and reduce server load.",
    date: "2023-08-22",
  ...
  },
  {
    ...
    excerpt: "An in-depth look at different authentication strategies for web applications, including JWT, OAuth, and session-based authentication.",
    date: "2023-07-15",
    ...
    <Card className="h-full flex flex-col hover:shadow-md transition-shadow">
      <CardHeader className="pb-4">
        ...
        <CardTitle className="text-xl">
          <Link href={`/blog/${post.slug}`} className="hover:text-primary transition-colors truncate">
            {post.title}
          </Link>
        </CardTitle>
      </CardHeader>
