// components/admin/user-profile-editor.tsx
"use client"
...
export default function UserProfileEditor({ currentUser, isCurrentUserAdmin = false }: UserProfileEditorProps) {
          ...
          <div className="flex flex-col items-center gap-6 mb-6 sm:flex-row sm:items-start">
            <div className="relative">
              ...
              <div className="absolute bottom-0 right-0 flex space-x-1">
                <label htmlFor="avatar-upload" className="flex items-center justify-center w-8 h-8 rounded-full cursor-pointer bg-primary">
      ...
      >
        <AlertDialogContent>
          ...
          <AlertDialogFooter>
            ...
            <AlertDialogAction onClick={saveProfileChanges}>
              Save Changes
            </AlertDialogAction>
          </AlertDialogFooter>
        </AlertDialogContent>
