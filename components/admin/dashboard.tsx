            ...
            <CardContent className="space-y-6">
              <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
                <div className="space-y-2">
                  ...
                  <select id="posts-per-page" className="w-full h-10 px-3 py-2 text-sm border rounded-md border-input bg-background">
                ...
                <div className="space-y-2">
                  ...
                  <select id="default-sort" className="w-full h-10 px-3 py-2 text-sm border rounded-md border-input bg-background">
          ...
          <Card>
            ...
            <CardContent className="space-y-6">
              ...
              <div className="space-y-2">
                ...
                <select id="fonts" className="w-full h-10 px-3 py-2 text-sm border rounded-md border-input bg-background">
              ...
              <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
                <div className="space-y-2">
                  ...
                  <select id="heading-style" className="w-full h-10 px-3 py-2 text-sm border rounded-md border-input bg-background">
                ...
                <div className="space-y-2">
                  ...
                  <select id="spacing" className="w-full h-10 px-3 py-2 text-sm border rounded-md border-input bg-background">
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              ...
              <div className="space-y-2">
                ...
                />
                <p className="text-xs text-muted-foreground">Receive notifications when new content is published</p>
              </div>
            ...
            <CardContent className="space-y-6">
              <div className="flex items-center gap-4 p-4 border rounded-lg border-border">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-xs text-muted-foreground">Track visitor analytics and user behavior</p>
                </div>
              ...
              <div className="flex items-center gap-4 p-4 border rounded-lg border-border">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-xs text-muted-foreground">Post notifications to Discord channels</p>
                </div>
            ...
            <CardContent className="space-y-4">
              ...
              <div className="flex items-center justify-between p-4 border rounded-lg border-red-500/20">
                <div>
                  ...
                  <p className="text-xs text-muted-foreground">Delete all blog posts, images, and files</p>
                </div>
                <Button variant="outline" size="sm" className="text-red-500 border-red-500/50 hover:bg-red-500/10">
                  Delete Content
                </Button>
