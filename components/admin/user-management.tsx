...
export default function UserManagement() {
  ...
  const [selectedUserPermissions, setSelectedUserPermissions] = useState<UserPermissions | null>(
    null,
  );
                            ...
                            <div className="space-y-3">
                              <div className="flex items-center justify-between">
                                ...
                                <Switch
                                  ...
                                  onCheckedChange={(checked) =>
                                    handlePermissionChange('canCreatePosts', checked)
                                  }
                              ...
                              <div className="flex items-center justify-between">
                                ...
                                <Switch
                                  ...
                                  onCheckedChange={(checked) =>
                                    handlePermissionChange('canEditOwnPosts', checked)
                                  }
                                  disabled={!canModifyUser(selectedUser) || isSubmitting}
                                />
                              </div>
                              ...
                              <div className="flex items-center justify-between">
                                ...
                                <Switch
                                  ...
                                  onCheckedChange={(checked) =>
                                    handlePermissionChange('canEditAllPosts', checked)
                                  }
                                  disabled={!canModifyUser(selectedUser) || isSubmitting}
                                />
                              </div>
                              ...
                              <div className="flex items-center justify-between">
                                ...
                                <Switch
                                  ...
                                  onCheckedChange={(checked) =>
                                    handlePermissionChange('canDeleteOwnPosts', checked)
                                  }
                                  disabled={!canModifyUser(selectedUser) || isSubmitting}
                                />
                              </div>
                              ...
                              <div className="flex items-center justify-between">
                                ...
                                <Switch
                                  ...
                                  onCheckedChange={(checked) =>
                                    handlePermissionChange('canDeleteAllPosts', checked)
                                  }
                                  disabled={!canModifyUser(selectedUser) || isSubmitting}
                                />
                              </div>
